...
package com.epam.digital.data.platform.datafactory.excerpt.client;
 ...
 */
@FeignClient(name = "excerpt-client", url = "${excerpt-service-api.url}/excerpts",
        configuration = DataFactoryFeignDecoderConfiguration.class)
